...
def insert_sample_data():
    ...
    sample_assets = [
        ...
        ('TABLET011', 'iPad Pro', '平板电脑', '苹果', 'iPad Pro 12.9"', '2025-01-20', 6999.00, '15F-产品部-工位P12', 'borrowed', 'SF013'),
        ('ROUTER012', '企业路由器', '网络设备', '华为', 'AR6300', '2025-02-25', 4999.00, '15F-技术部-网络机柜', 'available', 'SF014'),
        ('LAPTOP013', '华硕游戏本', '笔记本电脑', '华硕', 'ROG Strix G15', '2025-03-30', 9999.00, '15F-研发部-工位R03', 'available', 'SF015'),
        ('WORKSTATION014', '戴尔工作站', '台式工作站', '戴尔', 'Precision 7000', '2025-04-05', 15999.00, '15F-运维部-工位O12', 'borrowed', 'SF016'),
        ('DRONE015', '航拍无人机', '无人机设备', '大疆', 'Air 2S', '2025-05-10', 6999.00, '15F-测试部-充电站', 'available', 'SF017')
    ]
    ...
    # 插入示例借用记录 - 更多真实数据
    borrow_data = [
        (2, '王建国', '市场部', '2025-03-10', '2025-09-20', 'borrowed'),
        (7, '李明华', '项目组', '2025-04-12', '2025-10-19', 'borrowed'),
        (1, '张志强', '研发部', '2025-01-08', '2025-07-15', 'returned'),
        (3, '陈晓东', '技术部', '2025-02-05', '2025-06-12', 'returned'),
        (5, '刘小红', '创意部', '2025-05-14', '2025-12-21', 'borrowed'),
        (4, '赵敏', '测试部', '2025-01-11', '2025-01-18', 'returned'),
        (6, '孙大伟', '运维部', '2025-01-13', '2025-01-20', 'borrowed'),
        (8, '周小丽', '产品部', '2025-01-09', '2025-01-16', 'returned'),
        (1, '陈思雨', '研发部', '2025-02-15', '2025-09-22', 'borrowed'),
        (2, '林志豪', '设计部', '2025-03-16', '2025-10-23', 'borrowed'),
        (3, '黄小明', '技术部', '2025-04-14', '2025-07-21', 'returned'),
        (4, '吴大伟', '测试部', '2025-01-13', '2025-01-20', 'borrowed'),
        (5, '范小芳', '创意部', '2025-02-17', '2025-09-24', 'borrowed'),
        (6, '刘小菲', '运维部', '2025-01-12', '2025-01-19', 'returned'),
        (7, '胡小歌', '研发部', '2025-03-18', '2025-10-25', 'borrowed'),
        (8, '杨小美', '产品部', '2025-01-11', '2025-01-18', 'returned'),
        (1, '邓小超', '行政部', '2025-04-19', '2025-11-26', 'borrowed'),
        (2, '孙小丽', '市场部', '2025-01-10', '2025-01-17', 'returned'),
        (3, '赵小颖', '技术部', '2025-05-20', '2025-12-27', 'borrowed'),
        (4, '迪小热', '测试部', '2025-01-09', '2025-01-16', 'returned'),
        (5, '古小娜', '创意部', '2025-06-21', '2026-01-28', 'borrowed'),
        (6, '宋小茜', '运维部', '2025-01-08', '2025-01-15', 'returned'),
        (7, '易小千', '研发部', '2025-01-22', '2025-08-29', 'borrowed'),
        (8, '王小凯', '产品部', '2025-01-07', '2025-01-14', 'returned'),
        (1, '王小源', '行政部', '2025-02-23', '2025-09-30', 'borrowed'),
        (2, '鹿小晗', '市场部', '2025-01-06', '2025-01-13', 'returned'),
        (3, '吴小凡', '技术部', '2025-03-24', '2025-10-31', 'borrowed'),
        (4, '张小兴', '测试部', '2025-01-05', '2025-01-12', 'returned'),
        (5, '李小峰', '创意部', '2025-04-25', '2026-02-01', 'borrowed'),
        (6, '杨小洋', '运维部', '2025-01-04', '2025-01-11', 'returned'),
        (7, '陈小霆', '研发部', '2025-05-26', '2026-02-02', 'borrowed'),
        (8, '李小硕', '产品部', '2025-01-03', '2025-01-10', 'returned'),
        (1, '宋小基', '行政部', '2025-06-27', '2026-03-03', 'borrowed'),
        (2, '朴小剑', '市场部', '2025-01-02', '2025-01-09', 'returned'),
        (3, '金小贤', '技术部', '2025-01-28', '2025-08-04', 'borrowed'),
        (4, '李小镐', '测试部', '2025-01-01', '2025-01-08', 'returned'),
        (9, '王五', '网络部', '2025-01-15', '2025-08-22', 'borrowed'),
        (10, '赵六', '硬件部', '2025-01-16', '2025-08-23', 'available')
    ]
    ...
    # 插入示例维护记录
    maintenance_data = [
        (4, '定期保养', '2025-01-10', '王志伟', '无人机电池校准和螺旋桨检查', 850.00, 'ongoing', '2025-07-10'),
        (1, '屏幕更换', '2025-01-12', '李娜', '更换损坏的笔记本电脑屏幕', 1200.00, 'completed', None),
        (3, '系统升级', '2025-01-15', '张鹏', '服务器操作系统版本升级', 0.00, 'completed', None),
        (5, '电池更换', '2025-01-18', '刘洋', '更换老化电池', 500.00, 'ongoing', '2025-07-18'),
        (2, '主板维修', '2025-01-20', '陈静', '维修无法开机的笔记本电脑', 2500.00, 'ongoing', None),
        (6, '网络配置', '2025-01-22', '黄磊', '配置新的网络交换机', 300.00, 'completed', None),
        (7, '软件安装', '2025-01-25', '周涛', '安装专业设计软件', 0.00, 'completed', '2025-07-25'),
        (8, '天线校准', '2025-02-01', '王志伟', '校准无人机天线', 200.00, 'planned', '2025-08-01'),
        (9, '镜头清洁', '2025-02-05', '李娜', '清洁相机镜头', 50.00, 'completed', None),
        (10, '固件升级', '2025-02-10', '张鹏', '升级示波器固件', 0.00, 'planned', '2025-08-10')
    ]
    ...
    # 插入示例盘点记录
    inventory_data = [
        ('2025-01-15', 1, '1F-研发部-工位A12', '1F-研发部-工位A12', 'normal', '张伟'),
        ('2025-01-15', 3, '1F-机房-机柜A15', '1F-机房-机柜B12', 'abnormal', '李静'),
        ('2025-01-15', 5, '2F-创意部-工位C08', '2F-创意部-工位C08', 'normal', '王强'),
        ('2025-01-16', 2, '15F-设计部-工位D05', '15F-市场部-会议室', 'abnormal', '赵丽'),
        ('2025-01-16', 4, '15F-测试部-设备柜', '无法定位', 'missing', '孙超'),
        ('2025-01-17', 6, '15F-机房-存储区', '15F-机房-存储区', 'normal', '周鹏'),
        ('2025-01-17', 7, '15F-研发部-工位R08', '15F-研发部-工位R08', 'normal', '吴迪'),
        ('2025-01-18', 8, '15F-测试部-充电区', '15F-测试部-充电区', 'normal', '郑洋')
    ]
