...
def insert_sample_data():
    ...
    # 插入示例资产数据 - 高价值可移动设备
    sample_assets = [
        ('LAPTOP001', '联想ThinkPad P1', '移动工作站', '联想', 'ThinkPad P1 Gen4', '2023-01-15', 18999.00, '15F-研发部-工位R12', 'available', 'SF001'),
        ('LAPTOP002', '戴尔Precision 7560', '移动工作站', '戴尔', 'Precision 7560', '2023-02-20', 22999.00, '15F-设计部-工位D05', 'borrowed', 'SF002'),
        ('SERVER003', '边缘计算服务器', '便携服务器', '华为', 'FusionServer 2288H V5', '2023-03-10', 35999.00, '15F-机房-机柜A15', 'available', 'SF003'),
        ('DRONE004', '大疆无人机', '无人机设备', '大疆', 'Matrice 300 RTK', '2023-01-25', 45999.00, '15F-测试部-设备柜', 'maintenance', 'SF004'),
        ('LAPTOP005', '苹果MacBook Pro', '笔记本电脑', '苹果', 'MacBook Pro 16"', '2023-04-05', 25999.00, '15F-市场部-工位M03', 'borrowed', 'SF005'),
        ('SERVER006', '移动存储服务器', '存储设备', '戴尔', 'PowerVault ME4012', '2023-02-15', 28999.00, '15F-机房-存储区', 'available', 'SF006'),
        ('WORKSTATION007', '图形工作站', '移动工作站', '惠普', 'ZBook Fury 17 G8', '2023-05-20', 32999.00, '15F-研发部-工位R08', 'borrowed', 'SF007'),
        ('DRONE008', '测绘无人机', '无人机设备', '大疆', 'Phantom 4 RTK', '2023-03-25', 15999.00, '15F-测试部-充电区', 'available', 'SF008'),
        # 新增更多设备以支持借用记录
        ('CAMERA009', '佳能单反相机', '摄影设备', '佳能', 'EOS R5', '2023-06-10', 12999.00, '15F-行政部-设备柜', 'borrowed', 'SF009'),
        ('PROJECTOR010', '激光投影仪', '会议设备', '爱普生', 'EB-L1755U', '2023-07-15', 8999.00, '15F-设计部-会议室', 'available', 'SF010'),
        ('TABLET011', 'iPad Pro', '平板电脑', '苹果', 'iPad Pro 12.9"', '2023-08-20', 6999.00, '15F-产品部-工位P12', 'borrowed', 'SF011'),
        ('ROUTER012', '企业路由器', '网络设备', '华为', 'AR6300', '2023-09-25', 4999.00, '15F-技术部-网络机柜', 'available', 'SF012'),
        ('LAPTOP013', '华硕游戏本', '笔记本电脑', '华硕', 'ROG Strix G15', '2023-10-30', 9999.00, '15F-研发部-工位R03', 'available', 'SF013'),
        ('WORKSTATION014', '戴尔工作站', '台式工作站', '戴尔', 'Precision 7000', '2023-11-05', 15999.00, '15F-运维部-工位O12', 'borrowed', 'SF014'),
        ('DRONE015', '航拍无人机', '无人机设备', '大疆', 'Air 2S', '2023-12-10', 6999.00, '15F-测试部-充电站', 'available', 'SF015')
    ]
